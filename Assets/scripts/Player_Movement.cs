...
public class Player_Movement : MonoBehaviour
{
    ...
    {
        bool fridgeOpen = FridgeController.Instance != null && FridgeController.Instance.IsOpen();
        bool minigameOpen = CookingMinigame.Instance != null && CookingMinigame.Instance.IsMinigameActive;

        if (fridgeOpen || minigameOpen)
        {
    ...
    IEnumerator VaultingEnum()
    {
        ...
        Physics.Raycast(estimatedLedge_Position, -transform.up, out TrueLedge_Position, Mathf.Infinity);
